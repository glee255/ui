...
if 'vectorizer' not in sl.session_state:
    sl.session_state.vectorizer = None
if 'data' not in sl.session_state:
    sl.session_state.data = None
if 'index' not in sl.session_state:
    sl.session_state.index = None
...
"""Hi, I am Gayeon Lee. I am a Data and Analytics professional with a proven record of industry experience. 
   ...
   Ask below to explore and learn about me"""
...
if sl.session_state.vectorizer is None:
