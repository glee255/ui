...
def load_data(): 
    ...
    if os.path.isfile("rag_personal/vector_cache"):
        with open("rag_personal/vector_cache", 'rb') as f:
...
if 'vectorizer' not in sl.session_state or 'data' not in sl.session_state or 'index' not in sl.session_state:
    print('init')
