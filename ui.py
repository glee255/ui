...
# sl.header("Entre any questions you would like to know.")
# Set the page configuration for a cleaner look


sl.header("What questions do you have for her?", anchor="chatbot-header")
...
q = sl.text_input("Your question", key="user_input")
